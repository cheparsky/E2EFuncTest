...
public class EkLibraryAndReader {
    ...
    public static void bAPobierzB() {
        ...
        MyDriver.buttonDownload(bPobierzB,
                bPlikA,
                "Audiobook");
        if (MyDriver.ifWWWNoEquals(curUrl)) {
            wd.navigate().back();
        }
    }
    ...
    public static void deleteFile(String fileName) {
        ...
        try {
            ...
            if (del) {
                System.out.println(file + " Został skasowany.");
            } else if (delj) {
                System.out.println(jfile + " Został skasowany.");
            } else {
                MyDriver.errMessage("Plik " + fileName + " NIE Został skasowany.");
            }
        } catch (Exception e) {
            MyDriver.errMessage("Nie udało się skasować pliku, patrz log:", e);
        }
    }
