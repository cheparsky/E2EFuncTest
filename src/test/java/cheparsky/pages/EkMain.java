...
public class EkMain {
    ...
    public static void dostepnoscStrona() {
        ...
        do {
            ...
            if (MyDriver.isVisible(sgUserB)) {
                System.out.println("Strona " + RunAutoTest.mainPage + " odpowiada");
                if (!EkMain.errMain.isEmpty()) {
                    MyDriver.errMessage("Strona " + RunAutoTest.mainPage + " odpowiada");
                }
                EkMain.stronaGlowna = true;
            } else {
                MyDriver.addMainErrList("Strona " + RunAutoTest.mainPage + " NIE odpowiada", errMain);
            ...
            if (licznik % 5 == 0) {
                ...
                try {
                    ...
                    MyDriver.addMainErrList("Nie ma połączenia internetowego...", errMain);
                }
            }
        }
        while (!stronaGlowna);
    ...
    public static void runWyloguj() {
        ...
        if (MyDriver.isVisible(sgWylogujB)) {
            ...
            MyDriver.errMessage("Strona główna nie zawiera przycisku 'Wyloguj'.");
        }
    }
